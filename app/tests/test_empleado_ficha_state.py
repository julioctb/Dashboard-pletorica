...
from app.domain.models.plaza import Plaza, PlazaResumen
import app.presentation.pages.portal.empleado_ficha.state as ficha_state_module
from app.presentation.pages.portal.empleado_ficha.state import EmpleadoFichaState
