...
from app.domain.models.contrato_item import ContratoItem, ContratoItemCreate
...
class ContratoItemService:
    ...
    async def crear_desde_requisicion(
        ...
        from app.domain.enums import EstadoRequisicion
        from app.domain.models import ContratoCreate
        from app.domain.services.requisicion_service import requisicion_service
