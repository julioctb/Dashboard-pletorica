...
from app.domain.enums import EstatusJornada, TipoRegistroAsistencia
from app.core.exceptions import BusinessRuleError, DatabaseError, NotFoundError
from app.domain.models.asistencia import JornadaAsistencia, JornadaAsistenciaCreate, RegistroAsistencia

if TYPE_CHECKING:
    from app.domain.services.asistencia_service import AsistenciaService
