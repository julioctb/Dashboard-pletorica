...
from app.domain.models.empleado_restriccion_log import EmpleadoRestriccionLogResumen
from app.domain.enums import AccionRestriccion, EstatusEmpleado, MotivoBaja
