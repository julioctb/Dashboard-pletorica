...
class StatusColors:
    ...
    @classmethod
    def get_nomina_step_label(cls, estatus: str) -> str:
        """Obtiene la etiqueta para un paso del workflow de nómina."""
        labels = {
            "BORRADOR": "Abierto",
            "EN_PREPARACION_RRHH": "En preparación",
            "ENVIADO_A_CONTABILIDAD": "Enviado",
            "EN_PROCESO_CONTABILIDAD": "En contabilidad",
            "CALCULADO": "Listo para pago",
            "CERRADO": "Cerrado",
        }
        return labels.get(estatus.upper(), estatus)

    @classmethod
    def get_entregable_status_label(cls, estatus: str) -> str:
        """Obtiene la etiqueta para estado de entregable."""
        labels = {
            "PENDIENTE": "Pendiente",
    ...
    @classmethod
    def get_entregable_status_color_scheme(cls, estatus: str) -> str:
        """Obtiene el color_scheme para estado de entregable."""
        schemes = {
            "PENDIENTE": "gray",
            "EN_REVISION": "sky",
            "APROBADO": "green",
        ...
        return schemes.get(estatus.upper(), "gray")

    @classmethod
    def get_tipo_incidencia_label(cls, tipo: str) -> str:
        """Obtiene la etiqueta para un tipo de incidencia."""
        labels = {
            "FALTA": "Falta",
            "RETARDO": "Retardo",
        ...
        return labels.get(tipo.upper(), tipo)
