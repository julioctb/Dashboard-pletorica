        ...
        rx.grid(
            rx.cond(
                ...
                _quick_link(
                    "Contrato",
                    "file-text",
                    PortalState.ruta_contrato_principal,
                    "Consulta la cartera activa de contratos",
                ),
                rx.fragment(),
            ),
            rx.cond(
                ...
                _quick_link(
                    "Entregables",
                    "package-check",
                    PortalState.ruta_entregables_principal,
            ...
            rx.cond(
                ...
                _quick_link(
                    "RRHH",
                    "users",
                    PortalState.ruta_rrhh_principal,
                    "Gestiona personal, expedientes y asistencias",
                ),
                rx.fragment(),
            ),
            rx.cond(
                ...
                _quick_link(
                    "Nominas",
                    "calculator",
                    PortalState.ruta_nominas_principal,
            ...
            rx.cond(
                ...
                _quick_link(
                    "Empresa",
                    "building-2",
                    PortalState.ruta_empresa_principal,
                    "Datos generales, configuracion y usuarios",
                ),
                rx.fragment(),
            ),
            rx.cond(
                ...
                _quick_link(
                    "Auto servicio",
                    "user-check",
                    PortalState.ruta_autoservicio_principal,
                    "Completa datos personales y expediente",
                ),
                rx.fragment(),
            ),
