...
from app.presentation.pages.backoffice.contratos.contratos_modals import (
    modal_contrato,
    modal_detalle_contrato,
    modal_confirmar_cancelar,
)
from app.presentation.pages.backoffice.contratos.pagos_state import PagosState
from app.presentation.pages.backoffice.contratos.pagos_modals import (
    modal_pagos,
    modal_pago_form,
