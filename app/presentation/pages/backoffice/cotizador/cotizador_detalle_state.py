...
from app.modules.cotizaciones.domain.validators import (
...
class CotizadorDetalleState(PortalState):
    ...
    async def cargar_detalle(self):
        ...
        try:
            ...
            from app.modules.cotizaciones.application import cotizacion_service
    ...
    async def guardar_info_cotizacion(self):
        ...
        try:
            ...
            from app.domain.models import CotizacionUpdate
            from app.modules.cotizaciones.application import cotizacion_service
    ...
    async def cambiar_estatus_cotizacion(self, nuevo_estatus: str):
        ...
        try:
            from app.modules.cotizaciones.application import cotizacion_service
            from app.modules.cotizaciones.domain.enums import EstatusCotizacion
    ...
    async def agregar_categoria(self):
        ...
        try:
            from app.modules.cotizaciones.application import cotizacion_service
            from app.domain.models import CotizacionPartidaCategoriaCreate
    ...
    async def agregar_concepto(self):
        ...
        try:
            from app.modules.cotizaciones.application import cotizacion_service
            from app.domain.models import CotizacionConceptoCreate
            from app.modules.cotizaciones.domain.enums import TipoConceptoCotizacion, TipoValorConcepto
    ...
    async def cambiar_estatus_partida_local(self, nuevo_estatus: str):
        ...
        try:
            from app.modules.cotizaciones.application import cotizacion_service
            from app.modules.cotizaciones.domain.enums import EstatusPartidaCotizacion
    ...
    async def agregar_item_detalle(self):
        ...
        try:
            from decimal import Decimal
            from app.modules.cotizaciones.application import cotizacion_service
            from app.domain.models import CotizacionItemCreate
