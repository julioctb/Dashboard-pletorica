...
from app.domain.enums import ReglaCalculoQuincenal
from app.domain.models.configuracion_fiscal_empresa import ConfiguracionFiscalEmpresaUpdate
from app.domain.models.configuracion_operativa_empresa import ConfiguracionOperativaEmpresaUpdate
from app.presentation.pages.portal.state.portal_state import PortalState
from app.modules.application import configuracion_fiscal_service
from app.modules.application import configuracion_operativa_service
