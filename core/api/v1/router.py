...
from core.api.v1.empresas.router import router as empresas_router
from core.api.v1.curp.router import router as curp_router
from core.api.v1.onboarding.router import router as onboarding_router
...
# from core.api.v1.empleados.router import router as empleados_router
