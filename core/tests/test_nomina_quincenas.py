...
services_pkg = types.ModuleType("core.domain.services")
services_pkg.__path__ = [os.path.join(os.getcwd(), "app", "services")]
sys.modules.setdefault("core.domain.services", services_pkg)
...
from core.domain.models.empleado_descuento_recurrente import EmpleadoDescuentoRecurrenteCreate

nomina_periodo_module = importlib.import_module("core.domain.services.nomina_periodo_service")
...
def test_transicionar_a_preparacion_materializa_descuentos_recurrentes_rrhh(monkeypatch):
    ...
    sys.modules["core.domain.services.empleado_descuento_recurrente_service"] = types.SimpleNamespace(
...
def test_resumen_operativo_cuenta_permiso_sin_goce_como_inasistencia(monkeypatch):
    ...
    sys.modules["core.domain.services"].plaza_service = types.SimpleNamespace(
