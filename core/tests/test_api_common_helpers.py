...
# Stub de modulo fastapi antes de cargar core.api.v1.common.errors
...
# Stub de paquetes para evitar import de core.api.main (requiere FastAPI real)
app_api_stub = types.ModuleType("core.api")
app_api_v1_stub = types.ModuleType("core.api.v1")
app_api_v1_schemas_stub = types.ModuleType("core.api.v1.schemas")
app_api_v1_schemas_stub.APIResponse = _SimpleAPIResponse
app_api_v1_schemas_stub.APIListResponse = _SimpleAPIListResponse
_original_core_api = sys.modules.get("core.api")
_original_core_api_v1 = sys.modules.get("core.api.v1")
_original_core_api_v1_schemas = sys.modules.get("core.api.v1.schemas")
sys.modules["core.api"] = app_api_stub
sys.modules["core.api.v1"] = app_api_v1_stub
sys.modules["core.api.v1.schemas"] = app_api_v1_schemas_stub
...
try:
    ...
    if _original_core_api is not None:
        sys.modules["core.api"] = _original_core_api
    else:
        sys.modules.pop("core.api", None)
    if _original_core_api_v1 is not None:
        sys.modules["core.api.v1"] = _original_core_api_v1
    else:
        sys.modules.pop("core.api.v1", None)
    if _original_core_api_v1_schemas is not None:
        sys.modules["core.api.v1.schemas"] = _original_core_api_v1_schemas
    else:
        sys.modules.pop("core.api.v1.schemas", None)
