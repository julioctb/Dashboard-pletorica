...
_original_app_entities_notificacion = sys.modules.get("core.domain.models.notificacion")
...
_app_entities_notif_stub = types.ModuleType("core.domain.models.notificacion")
...
sys.modules["core.domain.models.notificacion"] = _app_entities_notif_stub
try:
    ...
    if _original_app_entities_notificacion is not None:
        sys.modules["core.domain.models.notificacion"] = _original_app_entities_notificacion
    else:
        sys.modules.pop("core.domain.models.notificacion", None)
