...
from core.domain.services.contratos import ContratoItemService, ContratoMutationService, ContratoQueryService
from core.domain.services.empleados import (
    EmpleadoMutationService,
    EmpleadoQueryService,
    EmpleadoRestrictionService,
)
from core.domain.services.asistencia_config_service import AsistenciaConfigService as LegacyAsistenciaConfigService
from core.domain.services.asistencia_incidencia_service import AsistenciaIncidenciaService as LegacyAsistenciaIncidenciaService
from core.domain.services.asistencia_jornada_service import AsistenciaJornadaService as LegacyAsistenciaJornadaService
from core.domain.services.asistencia_panel_service import AsistenciaPanelService as LegacyAsistenciaPanelService
...
from core.domain.services.user_auth_service import UserAuthService as LegacyUserAuthService
from core.domain.services.user_company_service import UserCompanyService as LegacyUserCompanyService
from core.domain.services.user_profile_service import UserProfileService as LegacyUserProfileService
