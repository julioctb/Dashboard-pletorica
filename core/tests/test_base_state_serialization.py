...
_original_app_core_config = sys.modules.get("core.core.config")
_app_core_config_stub = types.ModuleType("core.core.config")
...
sys.modules["core.core.config"] = _app_core_config_stub
try:
    _SPEC.loader.exec_module(_MOD)
finally:
    if _original_app_core_config is not None:
        sys.modules["core.core.config"] = _original_app_core_config
    else:
        sys.modules.pop("core.core.config", None)
