...
from core.presentation.pages.portal.contrato_plazas.state import ContratoPlazasState
from core.presentation.pages.portal.mis_empleados.state import MisEmpleadosState
