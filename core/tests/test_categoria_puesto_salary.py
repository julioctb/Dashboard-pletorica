...
from core.domain.models.categoria_puesto import CategoriaPuestoCreate
from core.presentation.pages.backoffice.categorias_puesto.categorias_puesto_state import (
