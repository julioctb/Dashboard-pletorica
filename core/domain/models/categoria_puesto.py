...
from core.core.enums import Estatus
from core.core.validation.decimal_converters import convertir_a_decimal_opcional
...
from core.core.error_messages import msg_entidad_ya_estado
...
class CategoriaPuesto(BaseModel):
    ...
    salario_base_mensual: Optional[Decimal] = Field(
        default=None,
        ge=0,
        decimal_places=2,
        description="Sueldo base mensual sugerido para plazas de esta categoría",
    )
    ...
    @field_validator("salario_base_mensual", mode="before")
    @classmethod
    def convertir_salario_base(cls, value):
        return convertir_a_decimal_opcional(value)
...
class CategoriaPuestoCreate(BaseModel):
    ...
    salario_base_mensual: Optional[Decimal] = Field(default=None, ge=0, decimal_places=2)
    estatus: Estatus = Field(default=Estatus.ACTIVO)
