...
from core.domain.models.contrato_categoria import ContratoCategoria
from core.core.exceptions import NotFoundError, DuplicateError, DatabaseError
...
class SupabaseContratoCategoriaRepository:
    ...
    def __init__(self, db_manager=None):
        if db_manager is None:
            from core.database import db_manager as default_db
