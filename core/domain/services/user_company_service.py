...
from core.core.exceptions import BusinessRuleError, DatabaseError, DuplicateError, NotFoundError, ValidationError
from core.domain.models.user_company import UserCompany, UserCompanyAsignacionInicial, UserCompanyResumen
from core.domain.models.user_profile import UserProfileCreate
...
class UserCompanyService:
    ...
    async def asignar_rol_empresa(
        ...
        from core.core.enums import RolEmpresa
    ...
    async def crear_o_vincular_usuario_empresa(
        ...
        from core.core.constants.permisos import PERMISOS_DEFAULT
