...
from core.core.enums import Estatus, EstatusContrato
from core.domain.repositories import SupabaseTipoServicioRepository
from core.core.exceptions import BusinessRuleError
from core.domain.services.base_service import BaseService
...
class TipoServicioService(BaseService):
    ...
    async def actualizar(self, tipo_id: int, tipo_update: TipoServicioUpdate) -> TipoServicio:
        ...
        if await self.repository.existe_clave(tipo_actual.clave, excluir_id=tipo_actual.id):
            from core.core.exceptions import DuplicateError
