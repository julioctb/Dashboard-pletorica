...
from core.core.enums import Estatus, EstatusContrato, EstatusJornada, RolEmpresa
from core.core.exceptions import DatabaseError
from core.domain.models.asistencia import EmpleadoAsistenciaEsperado, Horario, IncidenciaAsistencia, JornadaAsistencia, RegistroAsistencia
from core.domain.services.contrato_service import contrato_service
from core.domain.services.empleado_service import empleado_service
from core.domain.services.plaza_service import plaza_service

if TYPE_CHECKING:
    from core.domain.services.asistencia_service import AsistenciaService
