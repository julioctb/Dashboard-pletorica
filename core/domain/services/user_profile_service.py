...
from core.core.exceptions import BusinessRuleError, DatabaseError, NotFoundError, ValidationError
from core.domain.models.user_profile import UserProfile, UserProfileResumen, UserProfileUpdate
