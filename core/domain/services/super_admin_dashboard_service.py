...
from core.domain.models.super_admin_dashboard import SuperAdminDashboard
...
class SuperAdminDashboardService:
    ...
    async def obtener_metricas_super_admin(self) -> tuple[SuperAdminDashboard, list[str]]:
        ...
        from core.domain.services.dashboard_service import dashboard_service
        from core.domain.services.institucion_service import institucion_service
