...
from core.domain.repositories import SupabaseContratoCategoriaRepository
from core.core.exceptions import NotFoundError, BusinessRuleError
...
class ContratoCategoriaService:
    ...
    async def obtener_categorias_disponibles(
        ...
        """
        from core.domain.services import contrato_service, categoria_puesto_service
