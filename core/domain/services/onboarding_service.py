...
from core.core.enums import EstatusOnboarding
from core.core.exceptions import (
    BusinessRuleError,
    DatabaseError,
    ValidationError,
)
from core.domain.models.onboarding import AltaEmpleadoBuap, ExpedienteStatus
from core.domain.models.empleado import Empleado, EmpleadoCreate, EmpleadoUpdate
from core.domain.models.notificacion import NotificacionCreate
...
class OnboardingService:
    ...
    async def alta_empleado_buap(
        ...
        """
        from core.domain.services.curp_service import curp_service
        from core.domain.services.empleado_service import empleado_service
        from core.domain.services.notificacion_service import notificacion_service
    ...
    async def obtener_expediente(self, empleado_id: int) -> ExpedienteStatus:
        ...
        """
        from core.domain.services.empleado_documento_service import empleado_documento_service
    ...
    async def completar_datos(
        ...
        """
        from core.domain.models.onboarding import CompletarDatosEmpleado
        from core.domain.services.empleado_service import empleado_service
        from core.domain.services.cuenta_bancaria_historial_service import cuenta_bancaria_historial_service
