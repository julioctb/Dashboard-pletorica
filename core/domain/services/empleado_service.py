...
from core.domain.models.empleado_restriccion_log import EmpleadoRestriccionLogResumen
from core.core.enums import AccionRestriccion, EstatusEmpleado, MotivoBaja
...
def _get_historial_service():
    ...
    from core.domain.services.historial_laboral_service import historial_laboral_service
...
class EmpleadoService:
    ...
    async def sincronizar_estatus_por_plazas(
        ...
        *,
        ...
        Si el empleado está suspendido, conserva ese estatus.
        """
