...
from core.bootstrap.pages import (
    portal_onboarding_redirect_page,
    portal_plazas_redirect_page,
    root_dispatcher_page,
)
from core.modules.cotizaciones.ui.portal import cotizador_detalle_page, cotizador_page
from core.modules.empleados.ui.backoffice import empleados_page
from core.modules.empleados.ui.portal import (
...
from core.presentation.pages.backoffice.admin.usuarios.usuarios_page import usuarios_admin_page
from core.presentation.pages.backoffice.admin_onboarding import admin_onboarding_page
from core.presentation.pages.backoffice.categorias_puesto.categorias_puesto_page import (
    categorias_puesto_page,
)
from core.presentation.pages.backoffice.configuracion.configuracion_page import (
    configuracion_page,
)
from core.presentation.pages.backoffice.contratos.contratos_page import contratos_page
from core.presentation.pages.backoffice.empresas.empresa_documentacion_page import (
    empresa_documentacion_page,
)
from core.presentation.pages.backoffice.empresas.empresas_page import empresas_page
from core.presentation.pages.backoffice.entregables import (
    entregable_detalle_page,
    entregables_page,
)
from core.presentation.pages.backoffice.historial_laboral.historial_laboral_page import (
    historial_laboral_page,
)
from core.presentation.pages.backoffice.instituciones.instituciones_page import (
    instituciones_page,
)
from core.presentation.pages.backoffice.login.login_page import login_page
from core.presentation.pages.backoffice.mi_perfil import mi_perfil_page
from core.presentation.pages.backoffice.pagos.pagos_page import pagos_page
from core.presentation.pages.backoffice.plazas.plazas_page import plazas_page
from core.presentation.pages.backoffice.requisiciones.requisiciones_page import (
    requisiciones_page,
)
from core.presentation.pages.backoffice.sedes.sedes_page import sedes_page
from core.presentation.pages.backoffice.shared.empresa_documentacion_share_page import (
    empresa_documentacion_share_page,
)
from core.presentation.pages.backoffice.simulador.simulador_page import simulador_page
from core.presentation.pages.backoffice.tipo_servicio.tipo_servicio_page import (
    tipo_servicio_page,
)
from core.presentation.pages.portal.asistencias import asistencias_page
from core.presentation.pages.portal.configuracion_empresa import configuracion_empresa_page
from core.presentation.pages.portal.contrato_plazas import contrato_plazas_page
from core.presentation.pages.portal.documentacion_empresa import (
    documentacion_empresa_portal_page,
)
from core.presentation.pages.portal.mi_empresa import mi_empresa_page
from core.presentation.pages.portal.mis_contratos import mis_contratos_page
from core.presentation.pages.portal.mis_datos import mis_datos_page
from core.presentation.pages.portal.mis_entregables import mis_entregables_page
from core.presentation.pages.portal.portal_dashboard import portal_dashboard_page
from core.presentation.pages.portal.usuarios_empresa import usuarios_empresa_page
