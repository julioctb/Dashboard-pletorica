...
Uso:
    from core.presentation.layouts.backoffice import sidebar
...
from core.presentation.components.ui.form_input import select_items_from_options
from core.presentation.components.shared.auth_state import AuthState
from core.presentation.layouts.backoffice.sidebar_state import SidebarState
from core.presentation.layouts.backoffice.primitives import (
    collapsible_nav_item,
    nav_group,
    nav_group_label,
    route_is_active,
)
from core.presentation.components.ui.notification_bell import notification_bell, NotificationBellState
