...
from core.core.constants.permisos import PERMISOS_DEFAULT, ROLES_ASIGNABLES_POR_ADMIN_EMPRESA
from core.core.exceptions import DatabaseError, DuplicateError, BusinessRuleError, NotFoundError
...
from core.domain.services import user_service
...
class UsuariosEmpresaState(PortalState):
    ...
    async def guardar_edicion(self):
        ...
        try:
            ...
            from core.domain.models import UserProfileUpdate
