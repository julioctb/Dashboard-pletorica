...
from core.domain.services import entregable_service, archivo_service
from core.domain.models.archivo import EntidadArchivo, TipoArchivo, OrigenArchivo
from core.core.enums import EstatusEntregable
...
class MisEntregablesState(PortalState):
    ...
    async def subir_factura_xml(self, files: List[rx.UploadFile]):
        ...
        try:
            ...
            # Validar CFDI
            from core.core.validation.cfdi_validator import validar_cfdi, RFC_BUAP
