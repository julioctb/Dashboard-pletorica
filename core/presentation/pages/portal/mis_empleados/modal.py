...
from core.presentation.components.reusable import (
    employee_form_body,
    employee_form_modal,
...
from core.presentation.components.ui.modals import modal_detalle, modal_formulario
...
def modal_asignacion_plaza() -> rx.Component:
    return shared_modal_asignacion_plaza(MisEmpleadosState)


def modal_categoria_plaza() -> rx.Component:
    return shared_modal_categoria_plaza(MisEmpleadosState)


def modal_salario_plaza() -> rx.Component:
    return shared_modal_salario_plaza(MisEmpleadosState)


def modal_asignacion_sede_plaza() -> rx.Component:
    return shared_modal_asignacion_sede_plaza(MisEmpleadosState)


def modal_reasignacion_plaza() -> rx.Component:
    return shared_modal_reasignacion_plaza(MisEmpleadosState)
            ...
            rx.hstack(
                rx.vstack(
                    ...
                    rx.hstack(
                        ...
                        rx.cond(
                            MisEmpleadosState.empleado_detalle.get("estatus_portal", "") != "",
                            employee_status_badge(
                                MisEmpleadosState.empleado_detalle.get("estatus_portal", ""),
                                size="2",
                            ),
                        ...
                        rx.cond(
                            MisEmpleadosState.detalle_ficha_href != "",
                            rx.button(
                                rx.badge(
                                ...
                                on_click=MisEmpleadosState.ver_ficha_empleado(
