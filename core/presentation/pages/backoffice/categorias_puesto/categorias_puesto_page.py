...
from core.presentation.components.backoffice.categorias_puesto.categorias_puesto_modals import (
...
def fila_categoria(categoria: dict) -> rx.Component:
    ...
    return rx.table.row(
        ...
        rx.table.cell(
            rx.text(
                categoria["salario_base_mensual_fmt"],
                font_size=Typography.SIZE_SM,
...
ENCABEZADOS_CATEGORIAS = [
    ...
    {"nombre": "Sueldo base", "ancho": "140px"},
