...
"""
import reflex as rx
from core.presentation.components.ui.form_input import form_input, form_textarea, form_select
from core.presentation.components.ui import table_shell
from core.presentation.components.ui.modals import modal_confirmar_eliminar as modal_eliminar_generico
from core.presentation.components.ui.buttons import boton_guardar, boton_cancelar
from core.presentation.pages.backoffice.contratos.contrato_categorias_state import ContratoCategoriaState
            ...
            rx.vstack(
                ...
                rx.cond(
                    ...
                    form_select(
                        ...
                        options=ContratoCategoriaState.opciones_categoria,
                        error=ContratoCategoriaState.error_categoria_puesto_id,
                    ),
                ),
                ...
                # Costo unitario
                form_input(
                    label="Costo unitario (por persona/mes)",
                ...
                form_textarea(
                    label="Notas",
                    placeholder="Ej: Observaciones sobre la categoria",
