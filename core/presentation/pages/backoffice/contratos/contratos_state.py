...
from core.presentation.components.shared.crud_state_mixin import CRUDStateMixin
from core.core.ui_helpers import (
    FILTRO_TODOS,
...
from core.core.text_utils import normalizar_mayusculas, formatear_moneda, formatear_fecha
from core.core.utils import (
...
from core.core.enums import TipoContratacion, EstadoRequisicion
from core.domain.models.contrato_item import ContratoItemCreate
from core.core.enums import TipoEntregable, PeriodicidadEntregable
from core.domain.models.entregable import ContratoTipoEntregableCreate
...
from core.core.validation import validar_monto_requerido
...
class ContratosState(AuthState, CRUDStateMixin):
    ...
    async def guardar_contrato(self):
        ...
        try:
            ...
            if self.es_contexto_portal:
                from core.presentation.pages.portal.mis_contratos import MisContratosState
