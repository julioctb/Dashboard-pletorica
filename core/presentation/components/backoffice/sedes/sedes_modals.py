...
"""
import reflex as rx
from core.presentation.pages.backoffice.sedes.sedes_state import SedesState
...
def modal_sede() -> rx.Component:
    ...
    return modal_formulario(
        ...
        titulo=rx.cond(SedesState.es_edicion, "Editar Sede", "Nueva Sede"),
        icono="map-pin",
        on_guardar=SedesState.guardar_sede,
        on_cancelar=SedesState.cerrar_modal_sede,
        puede_guardar=SedesState.puede_guardar,
