...
class AlertasEntregablesState(rx.State):
    ...
    async def cargar_alertas(self):
        self.cargando = True
        try:
            from core.domain.services import entregable_service
...
def alertas_entregables_card() -> rx.Component:
    ...
    Uso: from core.presentation.components.backoffice.entregables import alertas_entregables_card
    """
    return rx.card(
        rx.vstack(
            rx.hstack(
...
def seccion_alertas_dashboard() -> rx.Component:
    ...
    Uso: from core.presentation.components.backoffice.entregables import seccion_alertas_dashboard
    """
    return rx.vstack(
