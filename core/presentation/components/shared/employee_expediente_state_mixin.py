...
from core.core.enums import TipoDocumentoEmpleado
from core.core.exceptions import BusinessRuleError, ValidationError
from core.core.text_utils import capitalizar_palabras
from core.domain.services.archivo_service import archivo_service
...
class EmployeeExpedienteStateMixin:
    ...
    async def handle_upload_documento(self, files: list[rx.UploadFile]):
        ...
        try:
            from core.domain.models.empleado_documento import EmpleadoDocumentoCreate
