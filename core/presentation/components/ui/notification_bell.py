...
Uso:
    from core.presentation.components.ui.notification_bell import notification_bell
...
from core.domain.models.notificacion import Notificacion
...
class NotificationBellState(rx.State):
    ...
    async def cargar_notificaciones(self):
        ...
        self.cargando = True
        try:
            from core.domain.services import notificacion_service
